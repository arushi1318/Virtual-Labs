...
check.onclick = function validateConnections() {
    ...
    const requiredConnections = [
        [MCB_Positive, FunctGeneA],    // (1-13)
        [MCB_Negative, FunctGeneB],    // (2-14)
        [FunctGeneC, Voltmeter_Positive], // (3-15)
        [FunctGeneD, Voltmeter_Negative], // (4-16)
        [Ammeter_Positive, FunctGeneC], // (5-15)
        [Ammeter_Positive, Ammeter_Negative], // (6-7)
        [Ammeter_Negative, ResistorPositive], // (8-11)
        [ResistorNegative, InductorPositive], // (9-12)
        [InductorNegative, CapacitorPositive], // (10-16)
        [CapacitorNegative, FunctGeneD]  // (11-16)
    ];
    ...
    if (isValid) {
        ...
        MCB.disabled = false; // Enable MCB button
    } else {
